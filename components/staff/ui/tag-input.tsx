    ...
    <Popover open={showSuggestionMenu} modal={false}>
      <PopoverAnchor asChild>
        <div id={id} className="relative">
          <div
            className={cn(
              "flex min-h-10 flex-wrap items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 transition-colors",
              disabled
      ...
      <PopoverContent
        ...
        className="z-[80] w-[var(--radix-popper-anchor-width)] min-w-[18rem] rounded-lg border border-slate-300 bg-white p-2 shadow-xl shadow-slate-200/70"
      >
