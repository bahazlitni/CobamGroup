...
export default function RoleSelectionPanel({
  ...
  return (
    <Panel
      ...
      description="Choisissez le type de pouvoir et les roles dynamiques attribues a ce compte. Le type User donne l'acces de base au portail staff."
    >
      <StaffField id="powerType" label="Type de pouvoir">
        <StaffSelect
          ...
          disabled={disabled}
          options={[
            ...(powerType === "ROOT" ? [{ value: "ROOT", label: "Root" }] : []),
      ...
      {powerType === "USER" ? (
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-500">
            Un compte user peut rester sans role dynamique ou cumuler plusieurs roles. Le role
            effectif est celui avec la priorite la plus forte.
          </p>
          <div className="space-y-2">
            {options.length === 0 ? (
        ...
        <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700">
          Le pouvoir Admin utilise automatiquement tout le catalogue de permissions regulieres.
          Aucun role dynamique n&apos;est requis.
        </div>
      )}
