...
export const ANIMATED_ICON_NAMES = [
  ...
  "copy",
  "ellipsis",
] as const satisfies readonly AnimatedIconName[];
...
function renderIconNode(icon: AnimatedIconName, className: string): ReactNode {
  switch (icon) {
    case "none":
      return null;
    case "loader":
...
export default function AnimatedIcon({
  ...
  const context = mode === "asButtonChild" ? "button" : mode === "asBadgeChild" ? "badge" : "none";
  ...
  const contentNode = customColor ? <span style={{ color: customColor }}>{content}</span> : content;
