...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz':
    resolution: {integrity: sha512-Ha1jR23Jw7qHdJwQBSBlxaE6IYdM7vSqhouhiBr4yqY+cMm6CniDo1ANPttgreX7vGe4IUZXG9Igol4Xh7Dv4A==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz}
    version: 2.7.8
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
