...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz':
    resolution: {integrity: sha512-7Dq94RB103DgdrmlDaMFAHN1bIKQvVAskU7/Wotha23gcOliCZ7/BEBKTsY2CbuygjkDTLcd+pX49+uPd4NQZA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.7.8.tgz}
    version: 2.7.8
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
