...
export const DEFAULT_ROLE_SEED_DEFINITIONS: DefaultRoleSeedDefinition[] = [
  ...
  },
  {
    ...
    color: "#b45309",
    priorityIndex: 20,
    description: "Responsable editorial, publication des articles et encadrement des auteurs.",
    permissions: [
      PERMISSIONS.ROLES_VIEW_BELOW_ROLE,
      PERMISSIONS.ROLES_ASSIGN_BELOW_ROLE,
      PERMISSIONS.USERS_VIEW_NON_BANNED_BELOW_ROLE,
  ...
  },
  {
    ...
    color: "#2563eb",
    priorityIndex: 40,
    description: "Contributeur catalogue avec accès de création et édition produit.",
    permissions: [
      PERMISSIONS.PRODUCTS_CREATE,
      PERMISSIONS.PRODUCTS_VIEW_ALL,
  ...
  },
  {
    ...
    color: "#be185d",
    priorityIndex: 40,
    description: "Contributeur éditorial avec accès à ses propres articles et contenus associés.",
    permissions: [
      PERMISSIONS.ARTICLES_CREATE,
      PERMISSIONS.ARTICLES_VIEW_ALL,
