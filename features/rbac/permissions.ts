...
export const PERMISSION_DEFINITIONS = [
  ...
  definePermission({
    ...
    label: "Voir les categories d'articles",
    resource: "article_categories",
    action: "view",
    group: "Categories d'articles",
  }),
  definePermission({
    key: "article_categories.create",
    label: "Creer des categories d'articles",
    resource: "article_categories",
    action: "create",
    group: "Categories d'articles",
  }),
  definePermission({
    ...
    label: "Supprimer toutes les categories d'articles",
    resource: "article_categories",
    action: "delete",
    scope: "all",
    group: "Categories d'articles",
  ...
  definePermission({
    ...
    label: "Supprimer les categories d'articles sous mon role",
    resource: "article_categories",
    action: "delete",
    scope: "below_role",
    group: "Categories d'articles",
  ...
  definePermission({
    ...
    label: "Supprimer mes categories d'articles",
    resource: "article_categories",
    action: "delete",
    scope: "own",
    group: "Categories d'articles",
  ...
  definePermission({
    ...
    label: "Forcer la suppression de toutes les categories d'articles",
    resource: "article_categories",
    action: "force_remove",
    scope: "all",
    group: "Categories d'articles",
    description:
      "Detache les articles lies avant de supprimer definitivement la categorie.",
  }),
  definePermission({
    key: "article_categories.force_remove.below_role",
    label: "Forcer la suppression des categories d'articles sous mon role",
    resource: "article_categories",
    action: "force_remove",
    scope: "below_role",
    group: "Categories d'articles",
  ...
  definePermission({
    ...
    label: "Forcer la suppression de mes categories d'articles",
    resource: "article_categories",
    action: "force_remove",
    scope: "own",
    group: "Categories d'articles",
  ...
  definePermission({
    ...
    label: "Forcer la suppression d'un media reference",
    resource: "media",
    action: "force_remove",
    group: "Medias",
    description:
      "Dereference un media encore utilise avant de le supprimer definitivement. Necessite aussi l'acces et la gestion des medias.",
  }),
